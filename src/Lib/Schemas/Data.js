  ...
  skills: [
    {
      ...
      content: [
        ...
        {
          label: "Front-end",
          value: "React.js, Next.js, Capacitor.js, React Native, Kotlin, HTML, CSS, Tailwind CSS, Mui, PWA, Redux"
        },
        {
          label: "Back-end",
          value: "Node.js, Express, PostgreSQL, Redis, Frappe, Hasura GraphQL"
        },
        {
  ...
  experience: {
    works: [
      {
        ...
        description: [
          ...
          "Designed and built advanced responsive layouts, screens/components using adverse technology stack (ReactJS, Next.js, Kotlin, React Native, Tailwind-CSS, RESTful APIs )",
          " Contributed to the development of mobile-centric applications using React Native, Ionic, and Capacitor.js, enabling in-app updates and functionalities like push notifications (OneSignal)",
    ...
    projects: [
      ...
      },
      {
        ...
        period: "",
        description: [
          "Developed UI components and contributed to minor database designs for a cross-border load board software facilitating freight movement between MENA, US, and Canada (built with React.js). Successfully showcased it in Frappé Verse Mumbai and in Frappe marketplace and Play Store",
        ],
      },
      {
        name: "Parlo",
