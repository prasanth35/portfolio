  ...
  return (
    ...
    >
      <div className='flex h-3/4 flex-col justify-center space-y-4 sm:space-y-6'>
        ...
        >
          Full-stack developer experienced in building <HighlightText>intuitive web interfaces</HighlightText> and{' '}
          <HighlightText>efficient backend systems.</HighlightText>
        </h1>
        <p
          className={clsx(
